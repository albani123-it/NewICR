<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LGDPoolDet.aspx.vb" Inherits="NewCRM.LGDPoolDet" %>
...
<body onload="fLoad();">
    ...
    <div>
        <center>
                ...
                <tr bgcolor="#ebecec">
                    <td><b>LGD Value</b></td>
                    <td><asp:TextBox ID="txtLGDValue" runat="server" Width="200px" CssClass="form-control"></asp:TextBox></td>
                </tr>
                <tr bgcolor="#f6f7f7" style="display:none;">
                    <td width="30%"><b>Distribution Baseline</b></td>
                    <td><asp:TextBox ID="txtDistributionBaseline" Width="200px" runat="server" CssClass="form-control"></asp:TextBox></td>
                </tr>
