        ...
        Try
            For i As Integer = 0 To dtUser.Rows.Count - 1
                If dtUser.Rows(i).Item("ld_lm_description") = "lvl_bsl_fon_mgt" Then
                    tf = True
                End If
                If dtUser.Rows(i).Item("ld_lm_description") = "lvl_bsl_fon_edit" Or dtUser.Rows(i).Item("ld_lm_description") = "lvl_bsl_fon_view" Then
                    edit = True
                End If
            Next
            If Not tf Then
        ...
        If dt.Rows.Count > 0 Then
            For j As Integer = 1 To dt.Rows.Count
                If dt.Rows(j - 1).Item("tmod") > 0 Then
                    ...
                    dtModel = oAsset.getModelForAsset(dt.Rows(j - 1).Item("id"), 2)
