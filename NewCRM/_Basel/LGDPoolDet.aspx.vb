...
#End Region
    ...
    Sub isiData(ByVal polid)
        Dim ds As DataSet
        Dim dt As DataTable
        ds = oAsset.getDetailOfPoolLGD(polid, "LGD")
        dt = ds.Tables(0)
        If dt.Rows.Count > 0 Then
            ...
            txtLGDValue.Text = dt.Rows(0).Item("pol_pd")
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If liBodyLoadAction.Text = "" Then
            ...
            oModel.value = txtLGDValue.Text
            oModel.baseline = txtDistributionBaseline.Text

            If ViewState("polid") IsNot Nothing Then
                Dim ds As DataSet
                Dim dt As DataTable
                ds = oAsset.getDetailOfPoolLGD(ViewState("polid"), "LGD")
                dt = ds.Tables(0)
                If dt.Rows.Count > 0 Then
                    Try
                        oAsset.updatePoolAsset(oModel, usrLogin, "UPDATE", ViewState("moid"), "LGD", ViewState("polid"))
                ...
                Else
                    Try
                        oAsset.insertPoolAsset(oModel, usrLogin, "NEW", ViewState("moid"), "LGD")
    ...
    Sub cekInputModel()
        ...
        End If
        If txtLGDValue.Text = "" Then
            lMsg &= "Please input LGD value.\n"
        End If
