<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="foundation.aspx.vb" Inherits="NewCRM.foundation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fModelDetail(scid, moid) {
            ...
            l_obj_argument.url = "foundationDet.aspx?astid=" + scid + "&moid=" + moid;
