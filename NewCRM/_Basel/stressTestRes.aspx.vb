...
#End Region
    ...
    Function isiDataStressResult()
        ...
        If Not String.IsNullOrEmpty(Request.QueryString("id")) Then
            ...
            dt = ds.Tables(0)
            If dt.Rows.Count > 0 Then
                html &= "<table cellspacing='0' cellpadding='4px' width='100%' style='text-align:left;border: thin solid #bcbcbc;'><tr><td style='padding-left:0px;'>"
                For i As Integer = 1 To dt.Rows.Count
                    ...
                    html += "<table id='tbl" & dt.Rows(i - 1).Item("sst_id").ToString & "' cellspacing='0' cellpadding='3px' width='100%' style='text-align:left;'>"
                    html += "<tr " & colors & ">"
