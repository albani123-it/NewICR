...
Partial Public Class borrowerMgmt
    ...
    '''<summary>
    '''BrwTypeFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents BrwTypeFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''BrwSecFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents BrwSecFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''BrwSccNameFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents BrwSccNameFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''BrwStatusFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents BrwStatusFilter As Global.Obout.Grid.GridTemplate
