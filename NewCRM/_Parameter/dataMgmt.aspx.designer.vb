...
Partial Public Class dataMgmt
    ...
    '''<summary>
    '''DataTypFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents DataTypFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''DataNameFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents DataNameFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''DataDescFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents DataDescFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''DataStatFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents DataStatFilter As Global.Obout.Grid.GridTemplate
