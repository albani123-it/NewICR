<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="calc_operator.aspx.vb" Inherits="NewCRM.calc_operator" %>
    ...
    <div>
        <center>
            <table cellspacing="1" cellpadding="1" width="98%" style="text-align:left">
			    <tr>
				    <td colspan="2" background="../Images/bg-head.gif" bgcolor="#86d857" style="border-radius: 10px 10px 0 0">
                        &nbsp;</td>
			    </tr>
            
                <tr bgcolor="#F6F5F0">
                   <td class="style3"><p>Select Operator</p></td> 
                </tr>
