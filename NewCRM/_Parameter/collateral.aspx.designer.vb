...
Partial Public Class collateral
    ...
    '''<summary>
    '''CollTypeFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents CollTypeFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''CollClassFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents CollClassFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''CollDescFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents CollDescFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''CollSourceFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents CollSourceFilter As Global.Obout.Grid.GridTemplate
    
    '''<summary>
    '''CollStatusFilter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents CollStatusFilter As Global.Obout.Grid.GridTemplate
