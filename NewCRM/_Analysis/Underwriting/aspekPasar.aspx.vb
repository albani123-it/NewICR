Public Class aspekPasar
    ...
    Protected pagename As String = "Aspek Pasar"
...
#End Region
    ...
    Sub isiData(ByVal no)
        Dim ds As DataSet
        Dim dt As DataTable
        ds = oApp.checkAppAspek(no, "Aspek Pasar")
        dt = ds.Tables(0)
        If dt.Rows.Count > 0 Then
            exists = True
        End If
                ...
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    For tmp As Integer = 0 To dtP.Rows.Count - 1
                        If dt.Rows(i).Item("lbr_field") = dtP.Rows(tmp).Item("lbp_lbr_field") = True Then
                            ...
                            oRat.insertUpdateAspekByAppno(appno.Value, dt.Rows(i).Item("lbr_id"), value, "Aspek Pasar", desc, usrLogin)
                        End If
                    Next
                Next
