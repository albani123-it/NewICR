<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ProyeksiCashflowDet.aspx.vb" Inherits="NewCRM.ProyeksiCashflowDet" %>
...
//        function linkbtnUpload() {
//            var l_obj_argument = new Object();
//            l_obj_argument.url = '';
//            oWindowscroll(l_obj_argument.url, 600, 500); 
//        }
        function linkbtnUpload() {
            var appno = document.getElementById("<%=appno.clientID %>").value;
            window.location.href = "DataUploadProyeksi.aspx?appno=" + appno;
        }
...
//        }
            $(document).ready(function () {
                 $("#tblcashflow").tableHeadFixer({ "left": 1 });
		    });
            ...
            <div class="bodyContent">
                ...
                <tr style="height:30px;" >
				    <td background="../../styles/grid/footer.gif" colspan="3">
                        <input type="button" id="btnUpload" onclick="linkbtnUpload()" class="inpBtn" value="Upload Proyeksi" />
                    </td>
			    </tr>
                </table>--%>
