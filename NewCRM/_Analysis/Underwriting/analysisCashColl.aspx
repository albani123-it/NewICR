<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="analysisCashColl.aspx.vb" Inherits="NewCRM.analysisCashColl" %>
        ...
        <div id='cssmenu'>
            ...
            <div class="bodyContent">
                ...
                <table class="tbl" cellspacing="0" cellpadding="2" width="100%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;">
                    ...
                    <tr bgcolor="#f6f7f7">
                        <td width="30%"><b>Nominal Deposito</b></td>
                        <td width="20%"></td>
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtNominalDeposito" runat="server" CssClass="inpTxt"  style="float:none;text-align:right;" value="0"  onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value);countKebutuhanKMK();"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        ...
                        <td></td>
                        <td>
                            <asp:TextBox ID="txtPorsiPembiayaan" runat="server" CssClass="inpTxt" style="float:none;margin-left:23px;text-align:right;" value="0" onkeyup="countKebutuhanKMK();"></asp:TextBox>
                            &nbsp; %
                        </td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
