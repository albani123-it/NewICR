<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="CorporateShareholders.aspx.vb" Inherits="NewCRM.CorporateShareholders" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fEdit(id) {
            ...
            l_obj_argument.url = "CorporateShareholdersDet.aspx?id=" + id + "&brwcode=" + brw + "&sisa=" + sisa + "&status=" + stat;
