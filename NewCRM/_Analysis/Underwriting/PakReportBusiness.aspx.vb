Public Class PakReportBusiness
    ...
    Protected pagename As String = "PAK Report Bisnis"
    ...
    Sub isiData(ByVal appno)
        Dim ds As DataSet
        Dim dSet As DataSet
        ds = oPak.getPakReportList(appno, "Bisnis")
    ...
    Function CheckExistFile(ByVal dataset As DataSet)
        ...
        If dt1.Rows.Count > 0 Then
            For index = 0 To dt1.Rows.Count - 1
                If dt1.Rows(index).Item("kode") = "MBK" Then
                    Dim mkFolder As String
                    mkFolder = "~/Document Upload/" & appno.Value & "/" + "MBK" + "/"
                    Dim filename As String = ""
                    filename = "MBK" + "_" + appno.Value + ".pdf"
