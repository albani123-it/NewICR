<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="mbk_download.aspx.vb" Inherits="NewCRM.mbk_download" %>
            ...
            <table cellspacing="0" cellpadding="1" width="100%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;margin-top: 5px;">
                <tr>
                    ...
                    <ClientSideEvents OnClientSelect="onRecordSelect" />
                            <Columns>
                                <obout:Column ID="Column5" DataField="lmbkf_id" Visible="false" runat="server"/>
                                <obout:Column ID="Column6" DataField="lmbkf_app_no" Visible="false" runat="server"/>
                                <obout:Column ID="Column7" DataField="lmbkf_file" HeaderText="Nama Dokumen" runat="server" ShowFilterCriterias="false" Width="70%">
