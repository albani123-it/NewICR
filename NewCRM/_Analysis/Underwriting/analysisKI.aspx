<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="analysisKI.aspx.vb" Inherits="NewCRM.analysisKI" %>
        ...
        <div id='cssmenu'>
            ...
            <div class="bodyContent">
                ...
                <table class="tbl" cellspacing="0" cellpadding="2" width="100%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;">
                    ...
                    <tr bgcolor="#ebecec">
                        <td><b>Nilai proyek / Nilai investasi</b></td>
                        <td></td>
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtNilaiProyek" runat="server" CssClass="inpTxt"  style="float:none;text-align: right;" value="1,000,000,000"></asp:TextBox>
                        </td>
                    </tr>

                    <tr>
                        <td colspan="3" background="../../Images/bg-head.gif" style="color:#fff;font-weight:bold;">PERHITUNGAN MAKSIMAL PEMBIAYAAN KI (PROGRESS PAYMENT)</td>
                    </tr>
                    ...
                    <tr bgcolor="#ebecec">
                        <td><b>Kebutuhan Fasilitas KI</b></td>
                        <td></td>
                        <td>
                            Rp.&nbsp
