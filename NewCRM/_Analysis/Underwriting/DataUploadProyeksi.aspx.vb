...
Public Class DataUploadProyeksi
    ...
    Protected pagename As String = "Data Upload Proyeksi"
...
#End Region
    ...
    Protected Sub download(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Dim dataItem As Hashtable = TryCast(grdDataUpload.Rows(rowIndex).ToHashtable(), Hashtable)
        Dim folderPath = oDt.path
        Try
            Dim filename = dataItem("dtu_file_location")
        ...
        Catch ex As Exception
            ...
            cs.RegisterStartupScript(Page.[GetType](), "alert", "alert('" & msg & ".');window.location.href='DataUploadProyeksi.aspx?appno=" & appno.Value & "';", True)
        End Try
    End Sub
