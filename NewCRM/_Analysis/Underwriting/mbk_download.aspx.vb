...
Public Class mbk_download
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("appno") IsNot Nothing Then
            If Not Page.IsPostBack Then
                ...
                Dim dt As DataTable
                '===========attachment================
                ds = oApp.checkMBKFile(Request.QueryString("appno"), "All", proses)
                grid2.DataSource = ds
                grid2.DataBind()
    ...
    Protected Sub download(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Dim dt As DataTable
        Dim json As String = ""
        ds = oApp.checkMBKFile_byappno(Request.QueryString("appno"))
        dt = ds.Tables(0)
        Dim docname As String = dt.Rows(0).Item("lmbkf_file")
        Dim mkFolder As String
        mkFolder = "~/Document Upload/" & Request.QueryString("appno") & "/MBK_files/"
