Public Class analysisManufacturer
...
#End Region
    ...
    Sub isiData(ByVal no)
        ...
        'Dim dSet As DataSet
        'Dim dTbl As DataTable
        'dSet = oLap.getProyeksiWorksheetManufacture(no)
        'dTbl = dSet.Tables(0)
        ...
        If dt.Rows.Count > 0 Then
            ...
            '        If dTbl.Rows(index).Item("acc_code") = "X00098" Then
            '            If dTbl.Rows(index)(4) = "n/a" Then
            '                txtCOGS.Text = dTbl.Rows(index)(4)
            '            Else
            '                txtCOGS.Text = oGen.moneyFormatTextBox(dTbl.Rows(index)(4))
            '            End If
            ...
            '    txtSales.Text = oGen.moneyFormatTextBox(dt.Rows(0).Item("lws_sales"))
            '    txtARTO.Text = oGen.CheckNullInt(dt.Rows(0).Item("lws_ARTO"))
            '    txtITO.Text = oGen.CheckNullInt(dt.Rows(0).Item("lws_ITO"))
            '    txtAPTO.Text = oGen.CheckNullInt(dt.Rows(0).Item("lws_APTO"))
            '    txtTC.Text = oGen.CheckNullInt(dt.Rows(0).Item("lws_TC"))
            '    txtProyeksiKebutuhanKMK.Text = oGen.moneyFormatTextBox(dt.Rows(0).Item("lws_proyeksiKebutuhanKMK"))
            'End If

            txtCOGS.Text = oGen.moneyFormatTextBox(dt.Rows(0).Item("lws_CoGS"))
            txtSGA.Text = oGen.moneyFormatTextBox(dt.Rows(0).Item("lws_sga"))
            txtSales.Text = oGen.moneyFormatTextBox(dt.Rows(0).Item("lws_sales"))
            txtARTO.Text = oGen.CheckNullInt(dt.Rows(0).Item("lws_ARTO"))
            txtITO.Text = oGen.CheckNullInt(dt.Rows(0).Item("lws_ITO"))
            txtAPTO.Text = oGen.CheckNullInt(dt.Rows(0).Item("lws_APTO"))
            txtTC.Text = oGen.moneyFormatTextBox(dt.Rows(0).Item("lws_TC"))
            txtProyeksiKebutuhanKMK.Text = oGen.moneyFormatTextBox(dt.Rows(0).Item("lws_proyeksiKebutuhanKMK"))
