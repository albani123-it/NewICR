<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="IndividualShareholders.aspx.vb" Inherits="NewCRM.IndividualShareholder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id='cssmenu' style="margin-bottom:20px;">
            ...
            <div class="bodyContent">
                ...
                <div id="divnotif" runat="server" class="notif" style="display:none;">
                    <div class="notif-header" width="100%">
                        <table width="100%" class="table table-striped table-bordered">
                            <tr>
                                <td bgcolor="#2A3F54"><span><b>Notifikasi</b></span></td>
                                <td align="right" bgcolor="#2A3F54"><a class="notif-close" onclick="document.getElementById('<%=divnotif.clientID %>').style.display='none'" title="Close">X</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <tr bgcolor="#f6f7f7">
                        <td style="padding:0;">
                            ...
                            AllowPageSizeSelection="false" AllowFiltering="true" AllowRecordSelection="false" FolderStyle="~/styles/grid">
                                ...
                                <Columns>
                                    <obout:Column id="Column1" runat="server" DataField="lis_id" Visible="false" />
                                        <obout:Column id="Column2" runat="server" DataField="lis_nama" HeaderText="Nama" ShowFilterCriterias="false" Width="13%">
                                    ...
                                    <obout:Column id="Column3" runat="server" DataField="lis_jabatan" HeaderText="Jabatan" ShowFilterCriterias="false" Width="13%">
                                    ...
                                    <obout:Column id="Column4" runat="server" DataField="lis_kepemilikanSaham" HeaderText="Kepemilikan Saham (%)" AllowFilter="false" Width="15%"></obout:Column>
                                    <obout:Column id="Column5" runat="server" DataField="lis_jumlahLembarSaham" HeaderText="Jumlah Lembar Saham" AllowFilter="false" Width="14%" DataFormatString="{0:N0}"></obout:Column>
                                    <obout:Column id="Column6" runat="server" DataField="lis_noKTP" HeaderText="No. KTP" ShowFilterCriterias="false" Width="13%">
                                        <TemplateSettings RowEditTemplateControlId="txtNoKTP" RowEditTemplateControlPropertyName="value" FilterTemplateId="NoKTPFilter" />
                                        <FilterOptions>
                                            <obout:FilterOption IsDefault="true" Type="Contains" />
                                        </FilterOptions>
                                    </obout:Column>
                                    <obout:Column id="Column7" runat="server" DataField="lis_npwp" HeaderText="NPWP" ShowFilterCriterias="false" Width="13%">
                ...
                <%--<fieldset style="margin-top:10px;border-radius:5px;background:#ebecec;">
                    ...
                    <obout:Grid id="grid2" runat="server" CallbackMode="true" Serialize="true" AllowSorting="false"
			                AutoGenerateColumns="false" EnableRecordHover="true" Width="100%" AllowAddingRecords="false" AllowFiltering="false"
                            AllowPageSizeSelection="false" AllowRecordSelection="false" FolderStyle="~/styles/btn_bank">
                        <Columns>
                            <obout:Column id="Column10" runat="server" DataField="lbr_id" Visible="false" />
                            <obout:Column id="Column11" runat="server" DataField="lbr_brw_code" HeaderText="Kode Borrower" Width="20%">
                                <TemplateSettings EditTemplateId="tplEditAssetClass" TemplateId="tplAssetClass" />
                            </obout:Column>
                            <obout:Column id="Column12" runat="server" DataField="lbr_score" HeaderText="Skor" Width="20%">
                                <TemplateSettings EditTemplateId="tplEditAssetClass" TemplateId="tplAssetClass" />
                            </obout:Column>
                            <obout:Column id="Column13" runat="server" DataField="lbr_rating" HeaderText="Rating" Width="20%">
                                <TemplateSettings EditTemplateId="tplEditAssetClass" TemplateId="tplAssetClass" />
                            </obout:Column>
                        </Columns>
                    </obout:Grid>
    ...
    <script type="text/javascript">
        ...
        function fEdit(id) {
            ...
            l_obj_argument.url = "IndividualShareholdersDet.aspx?id=" + id + "&brwcode=" + brw + "&sisa=" + sisa + "&status=" + stat;
