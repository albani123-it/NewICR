Public Class DataAgunan
    ...
    Sub isiData(ByVal appno)
        Dim ds As DataSet
        ds = oAgu.getListDataAgunan(appno)
    ...
    Protected Sub delete(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Try
            ...
            cs.RegisterStartupScript(Page.[GetType](), "alert", "alert('" + oGen.NotifikasiHapus() + "');window.location.href='DataAgunan.aspx?appno=" & appno.Value & "';", True)
        Catch ex As Exception
