<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="underwritingMon.aspx.vb" MasterPageFile="~/Site.Master" Inherits="NewCRM.underwritingMon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        aMenu("Analysis");
        function fBack() {
            window.location.href = "underwriting.aspx";
        }
    </script>
    <style type="text/css">
        .full-container
            ...
            <fieldset style="margin-top:10px;border-radius:5px;background:#ebecec;">
                ...
                <obout:Grid id="grid2" runat="server" Width="100%" CallbackMode="true" Serialize="true" AllowPaging="false" PageSize="-1"
                        ...
                        <Columns>
                            ...
                            <obout:Column ID="Column8" DataField="code" Visible="false" runat="server" />
