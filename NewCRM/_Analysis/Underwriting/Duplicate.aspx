<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Duplicate.aspx.vb" Inherits="NewCRM.Duplicate" %>
        ...
        <div id='cssmenu'>
            ...
            <div class="bodyContent">
                ...
                <table class="tbl" cellspacing="0" cellpadding="3" width="100%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;">
                    <tr>
                        <td colspan="2" class="detail" style="border-radius: 5px 0 0 0;"><b>DUPLIKASI</b></td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td width="40%"><b>Duplikasi Debitur</b></td>
                        <td width="60%">
                            <asp:CheckBox runat="server" ID="InpDebitur" />
                        </td>
                    </tr>
                    
                    <tr bgcolor="#ebecec">
                        <td><b>Duplikasi Pengurus</b></td>
                        <td>
                            <asp:CheckBox runat="server" ID="InpPengurus" />
                        </td>
                    </tr>

                    <tr bgcolor="#f6f7f7">
                        <td><b>Duplikasi Perusahaan</b></td>
                        <td>
                            <asp:CheckBox runat="server" ID="InpPerusahaan" />
                        </td>
                    </tr>

                    <tr bgcolor="#ebecec">
                        <td><b>Duplikasi One Obligor</b></td>
                        <td>
                            <asp:CheckBox runat="server" ID="InpObligor" />
                        </td>
                    </tr>
