...
#End Region
    ...
    Sub isiData(ByVal no)
        ...
        dt = ds.Tables(0)
        If dt.Rows.Count > 0 Then
            txtNominalDeposito.Text = oGen.moneyFormatTextBox(dt.Rows(0).Item("lws_deposito"))
        ...
        If lblNotif.Text = "" Then
            If appno.Value <> "" Then
                Try
                    ...
                    If dt.Rows.Count > 0 Then
                        'update data
                        oApp.updateWorksheetCashColl(Request, appno.Value, usrLogin)
                    Else
                        'insert data
                        oApp.insertWorksheetCashColl(Request, appno.Value, usrLogin)
                    End If
