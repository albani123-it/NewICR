...
Public Class LKNDet
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        ...
        If lblNotif.Text = "" Then
            ...
            'cs.RegisterStartupScript(Page.[GetType](), "alert", "alert('Data berhasil disimpan.');window.opener.location.href = window.opener.location.href;parent.window.close();", True)
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        If lblNotif.Text = "" Then
            ...
            Dim filez As HttpPostedFile = DirectCast(FileUpload1.PostedFile, HttpPostedFile)
            Dim filename As String = ""
            ...
            If dt.Rows.Count > 0 Then
                ...
                If dt.Rows(0).Item("extention_name").ToString() = "image" Then
                    ...
                    check = oGen.checkUploadData(dt.Rows(0).Item("extention_group").ToString(), filez.ContentLength)
    ...
    Protected Sub delete(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Try
            ...
            'cs.RegisterStartupScript(Page.[GetType](), "alert", "alert('Data berhasil didelete.')", True)
