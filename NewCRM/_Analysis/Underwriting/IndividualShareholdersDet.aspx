        ...
        <center>
            <table cellspacing="0" cellpadding="3" width="98%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;margin-top: 5px;margin-bottom:5px;">
                ...
                <tr bgcolor="#ebecec">
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtTglKTP" runat="server" CssClass="inpTxt" style="float:none;" ReadOnly="true"></asp:TextBox>
                ...
                <tr bgcolor="#f6f7f7">
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtExpKTP" runat="server" CssClass="inpTxt" style="float:none;" ReadOnly="true"></asp:TextBox>
