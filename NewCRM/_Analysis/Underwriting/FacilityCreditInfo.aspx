        ...
        <div id='cssmenu'>
            ...
            <div class="bodyContent">
                ...
                <tr bgcolor="#ebecec">
                    ...
                    <td><asp:TextBox ID="TxtJangkaWaktu" runat="server" Width="10%" CssClass="inpTxt" MaxLength="3" Value="0" onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value);fillNilai();"></asp:TextBox>&nbsp Bulan</td>
                    <td></td>
                    <td></td>
                </tr>
