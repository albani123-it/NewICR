...
Public Class StrukturPengurusPerusahaanDet
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("appno") IsNot Nothing Then
            app_no.Value = Request.QueryString("appno")
            ...
            If app_no.Value IsNot Nothing Then
                ...
                Else
                    ...
                    Try
                        ...
                        oSPP.insertStrukturPengurus(Request, app_no.Value, usrLogin, textFile.Value)
    ...
    Sub CekInput()
        ...
        lMsg &= oGen.checkInputInaJavascript("TextBox", "TTL", Request.Form("txtTgllahir"))
        ...
        'lMsg &= oGen.checkInputInaJavascript("TextBox", "Masa Kerja Dari", Request.Form("txtMasaKerjaDari"))
        'lMsg &= oGen.checkInputInaJavascript("TextBox", "Sampai Tanggal", Request.Form("txtSampaiTgl"))
