<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="CreditBusiness.aspx.vb" Inherits="NewCRM.CreditBusiness" ValidateRequest="false" %>
            ...
            <div class="bodyContent">
                ...
                <table class="tbl" cellspacing="0" cellpadding="3" width="100%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px 5px 0 0; ">
                    ...
                    <tr bgcolor="#f6f7f7">
                        ...
                        <td><asp:Label ID="lblNamaPerusahaan" runat="server"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Grup Perusahaan</b></td>
                        <td><asp:Label ID="lblGrupPerusahaan" runat="server"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td><b>Alamat Perusahaan</b></td>
                        <td><asp:Label ID="lblAlamatPerusahaan" runat="server"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Bidang Usaha</b></td>
                        <td><asp:Label ID="lblBidangUsaha" runat="server"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td><b>Jenis PAK</b></td>
                        <td><asp:Label ID="lblJenisPAK" runat="server"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Tujuan PAK</b></td>
                        <td><asp:Label ID="lblTujuanPAK" runat="server"></asp:Label></td>
                    </tr>
                </table>
                <table class="tbl" cellspacing="0" cellpadding="2" width="100%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 0 0 5px 5px;">
                    <tr>
                        <td colspan="2" background="../../Images/bg-head.gif" bgcolor="#ddedf6" class="tb-header">ANALISA BISNIS</td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td width="30%"><b>Aspek Umum dan Manajemen</b></td>
                        <td><asp:TextBox ID="txtAspekUmumMgmt" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Hubungan dengan Bank</b></td>
                        <td><asp:TextBox ID="txtHubunganBank" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td><b>Aspek Pemasaran</b></td>
                        <td><asp:TextBox ID="txtAspekPemasaran" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Aspek Teknis dan Produksi/Pembelian</b></td>
                        <td><asp:TextBox ID="txtAspekTeknisProduksiPembelian" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td><b>Aspek Keuangan</b></td>
                        <td><asp:TextBox ID="txtAspekKeuangan" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Potensi Kebutuhan Produk</b></td>
                        <td><asp:TextBox ID="txtPotensiKebutuhanProduk" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td><b>Track Record Perusahaan dan Pemilik Perusahaan</b></td>
                        <td><asp:TextBox ID="txtTrackRecordPerusahaanDanPemilik" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Kebutuhan Kredit</b></td>
                        <td><asp:TextBox ID="txtKebutuhanKredit" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td><b>Jaminan yang Akan Diserahkan</b></td>
                        <td><asp:TextBox ID="txtJaminan" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Kesimpulan dan Pendapat Hasil Analisa Bisnis</b></td>
                        <td><asp:TextBox ID="txtKesimpulan" runat="server" CssClass="inpTxt" TextMode="MultiLine" Rows="3" Width="600px"></asp:TextBox></td>
                    </tr>
                    <%--<tr style="height:30px">
				        <td background="../../styles/grid/footer.gif" colspan="4" style="border-radius: 0 0 5px 5px;">
