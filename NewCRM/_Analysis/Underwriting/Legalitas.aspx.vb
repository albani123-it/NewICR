Public Class Legalitas
    ...
    Protected pagename As String = "Legalitas dan Perijinan Usaha"
...
#End Region
    ...
    Protected Sub delete(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Try
            ...
            cs.RegisterStartupScript(Page.[GetType](), "alert", "alert('Data berhasil dihapus.');window.location.href='Legalitas.aspx?appno=" & appno.Value & "';", True)
        Catch ex As Exception
            Dim msg As String = ex.Message.Replace("'", "")
            cs.RegisterStartupScript(Page.[GetType](), "alert", "alert('" & msg & ".');window.location.href='Legalitas.aspx?appno=" & appno.Value & "';", True)
        End Try
    End Sub
End Class