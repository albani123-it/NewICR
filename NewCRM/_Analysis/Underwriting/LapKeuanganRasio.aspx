<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="LapKeuanganRasio.aspx.vb" Inherits="NewCRM.LapKeuanganRasio" %>
        ...
        <div id='cssmenu'>
            ...
            <div>
                <div class="bodyContent">
                    ...
                    <% =htmlForm %>
                    <table id="tblNote" cellspacing="0" cellpadding="3" width="100%" class="table table-striped table-bordered">
