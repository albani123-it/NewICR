<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PakReportBusiness.aspx.vb"
    Inherits="NewCRM.PakReportBusiness" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function getDownload(val){
             $.ajax({
             type: "POST",
             url: "CreditBusiness.aspx/getDownload",
             data: '{appno:"'+ val +'"}',
...
//             success: OnSuccessDeleteUser, 
        ...
        var l_obj_argument = new Object();
            if (flag == "Y")
            {
                if (namafile != "")
                {
                    if((namafile=="Memorandum_Bisnis_Kredit.aspx"))
                    {
                    
                    downloadFile(appNumb,"MBK");
                    }
                    else{
