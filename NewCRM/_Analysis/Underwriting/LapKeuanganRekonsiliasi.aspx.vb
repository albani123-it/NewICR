...
Public Class LapKeuanganRekonsiliasi
    ...
    Protected pagename As String = "Rekonsiliasi"
...
#End Region
    ...
    Sub generetform()
        ...
        For index = 0 To ds.Tables(0).Rows.Count() - 1
            ...
            For cols = 0 To ds.Tables(0).Columns.Count() - 2
