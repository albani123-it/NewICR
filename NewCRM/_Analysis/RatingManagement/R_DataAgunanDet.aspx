<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="R_DataAgunanDet.aspx.vb" Inherits="NewCRM.R_DataAgunanDet" %>
                ...
                <table id="tblFillDataHeader" class="tbl twister" cellspacing="0" cellpadding="3"
                    ...
                    <tr>
                        <td colspan="4" class="detail" style="display: none">
                            <asp:TextBox ID="txtId" runat="server" CssClass="inpTxt">0</asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td width="20%">
...
<tr>
                   ...
                   <tr id="rowNilai" runat="server" visible="True">
                    ...
                    <tr id="rowLuasTB" runat="server" visible="false">
                        ...
                        <td>
                            <asp:TextBox ID="txtLuasTanah" Width="75px" value="0" runat="server" CssClass="inpTxt"></asp:TextBox>&nbsp
                            m<sup>2</sup>(persegi)
                        </td>
                        <td>
                            <b>Luas Bangunan</b>
                        ...
                        <td>
                            <asp:TextBox ID="txtLuasBangunan" Width="75px" value="0" runat="server" CssClass="inpTxt"></asp:TextBox>&nbsp
                            m<sup>2</sup>(persegi)
                        </td>
                    </tr>
                    <tr id="rowNilaiPasarTB" runat="server" visible="false">
                        ...
                        <td>
                            <asp:TextBox ID="txtNilaiPasarLT" runat="server" CssClass="inpTxt" value="0" onkeypress="return isNumberKey(event)"
                                onkeyup="this.value=formatCurrency(this.value)" Width="200px"></asp:TextBox>
                            <span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtNilaiPasarLB" runat="server" CssClass="inpTxt" value="0" onkeypress="return isNumberKey(event)"
                                onkeyup="this.value=formatCurrency(this.value)" Width="200px"></asp:TextBox>
                            <span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>
                        </td>
                    </tr>
                    <tr id="rowNilaiLikuidTB" runat="server" visible="false">
                        ...
                        <td>
                            <asp:TextBox ID="txtNilaiLikuidasiLT" runat="server" CssClass="inpTxt" value="0"
                                onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value)"
                                Width="200px"></asp:TextBox>
                            <%--<span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>--%>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtNilaiLikuidasiLB" runat="server" CssClass="inpTxt" value="0"
                                onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value)"
                                Width="200px"></asp:TextBox>
                            <%--<span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>--%>
                        </td>
                    ...
                    <tr id="rowNilaiPengikatanTB" runat="server" visible="false">
                        ...
                        <td>
                            <asp:TextBox ID="txtNilaiPengikatanLT" runat="server" CssClass="inpTxt" value="0"
                                onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value)"
                                Width="200px"></asp:TextBox>
                            <span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>
                        </td>
                        ...
                        <td>
                            <asp:TextBox ID="txtNilaiPengikatanLB" runat="server" CssClass="inpTxt" value="0"
                                onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value)"
                                Width="200px"></asp:TextBox>
                            <span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>
                        </td>
                    ...
                    <tr id="rowNilaiAsuransiTB" runat="server" visible="false">
                        ...
                        <td>
                            <asp:TextBox ID="txtNilaiAsuransiLT" runat="server" CssClass="inpTxt" value="0" onkeypress="return isNumberKey(event)"
                                onkeyup="this.value=formatCurrency(this.value)" Width="200px"></asp:TextBox>
                            <%--<span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>--%>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtNilaiAsuransiLB" runat="server" CssClass="inpTxt" value="0" onkeypress="return isNumberKey(event)"
                                onkeyup="this.value=formatCurrency(this.value)" Width="200px"></asp:TextBox>
                            <%--<span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>--%>
                        </td>
                    </tr>
