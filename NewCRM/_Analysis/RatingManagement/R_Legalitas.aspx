<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="R_Legalitas.aspx.vb" Inherits="NewCRM.R_Legalitas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fEdit(id) {
            ...
            l_obj_argument.url = "R_LegalitasDet.aspx?id=" + id + "&brwcode=" + brw + "&status=" + stat;
