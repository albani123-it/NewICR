Public Class R_aspekKeuangan
    ...
    Protected pagename As String = "Aspek Keuangan"
                ...
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    For tmp As Integer = 0 To dtP.Rows.Count - 1
                        If dt.Rows(i).Item("lbr_field") = dtP.Rows(tmp).Item("lbp_lbr_field") = True Then
                            ...
                            oApp.insertUpdateAspek(brw_code.Value, dt.Rows(i).Item("lbr_id"), value, "Aspek Financial", desc, usrLogin)
                        End If
                    Next
