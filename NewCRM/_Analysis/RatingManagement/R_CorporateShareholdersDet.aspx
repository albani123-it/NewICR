<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="R_CorporateShareholdersDet.aspx.vb" Inherits="NewCRM.R_CorporateShareholdersDet" %>
        ...
        <center>
            <table cellspacing="0" cellpadding="3" width="98%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;margin-top: 5px;margin-bottom:5px;">
                ...
                <tr bgcolor="#f6f7f7">
                    ...
                    <td width="26%">
                        <asp:DropDownList ID="ddlTipeBadan" runat="server" CssClass="inpDdl" AutoPostBack="true"></asp:DropDownList>
                ...
                <tr bgcolor="#ebecec">
                    ...
                    <td>
                        <asp:TextBox ID="txtKepemilikanSaham" runat="server" CssClass="inpTxt" onkeypress="return isNumberKey(event)"></asp:TextBox>
                        <span style="color:Red;font-size:11pt;font-weight:bold;">&nbsp;*</span>
                    </td>
                    <td><b>Propinsi</b></td>
