Public Class R_CorporateShareholdersDet
...
#End Region
    ...
    Sub isiData(ByVal id)
        ...
        If dt.Rows.Count > 0 Then
            ...
            If Request.QueryString("sisa") <> "" Then
                sisa.Value = CInt(Request.QueryString("sisa")) + CInt(oGen.CheckNullInt(dt.Rows(0).Item("lcs_kepemilikanSaham")))
            End If
        End If

        If ddlTipeBadan.SelectedValue.ToString() = "10" Then
