Public Class R_CorporateShareholders
...
#End Region
    ...
    Protected Sub delete(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Try
            ...
            cs.RegisterStartupScript(Page.[GetType](), "alert", "alert('Data berhasil dihapus.');window.location.href='CorporateShareholders.aspx?appno=" & appno.Value & "';", True)
        Catch ex As Exception
