<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="R_DataUploadProyeksiDet.aspx.vb" Inherits="NewCRM.R_DataUploadProyeksiDet" %>
                        ...
                        <table>
                             <tr>
                              ...
                              <tr runat="server" id="TRWord">
                                <td> 
                                   &nbsp; Select only.xls files. The maximum file size is 20MB.
                                </td>
                             </tr>
                        </table>
                   </div>
