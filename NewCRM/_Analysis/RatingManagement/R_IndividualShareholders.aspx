<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="R_IndividualShareholders.aspx.vb" Inherits="NewCRM.R_IndividualShareholders" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fEdit(id) {
            ...
            l_obj_argument.url = "R_IndividualShareholdersDet.aspx?id=" + id + "&brwcode=" + brw + "&sisa=" + sisa + "&status=" + stat;
