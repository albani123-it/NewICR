<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="R_LapKeuanganLabaRugi.aspx.vb" Inherits="NewCRM.R_LapKeuanganLabaRugi" %>
...
<script type="text/javascript" src="../../Scripts/idxlibs/idxwidget.js"></script>
    ...
    function fAction(){
        ...
        function jscalc_pct_view(a, b,c,d,e) {
            idxwidget.lapkeuangancalc_pct_view(a, b, c,d,e);
        }
