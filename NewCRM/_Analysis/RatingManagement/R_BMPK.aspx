<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="R_BMPK.aspx.vb" Inherits="NewCRM.R_BMPK" %>
            ...
            <div class="bodyContent">
                ...
                <table class="tbl" cellspacing="0" cellpadding="2" width="100%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;">
                    ...
                    <tr bgcolor="#f6f7f7">
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtModal" runat="server" CssClass="inpTxtDisabled" style="float:none;" readonly="true"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr bgcolor="#ebecec">
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturTerkait" runat="server" CssClass="inpTxtDisabled" style="float:none;" value="0" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturPihakKetiga" runat="server" CssClass="inpTxtDisabled" style="float:none;" value="0" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturPihakKetigaGrup" runat="server" CssClass="inpTxtDisabled" style="float:none;" value="0" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturBUMN" runat="server" CssClass="inpTxtDisabled" style="float:none;" value="0" ReadOnly="true"></asp:TextBox>
                        </td>
                    ...
                    <tr bgcolor="#ebecec">
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtInhousePihakKetiga" runat="server" CssClass="inpTxtDisabled" style="float:none;" value="0" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td>
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturLimit1" runat="server" CssClass="inpTxt" style="float:none;" value="0" onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value);countTotal();"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td>
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturLimit2" runat="server" CssClass="inpTxt" style="float:none;" value="0" onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value);countTotal();"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td>
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturLimit3" runat="server" CssClass="inpTxt" style="float:none;" value="0" onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value);countTotal();"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td>
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturLimit4" runat="server" CssClass="inpTxt" style="float:none;" value="0" onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value);countTotal();"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td>
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtDebiturLimit5" runat="server" CssClass="inpTxt" style="float:none;" value="0" onkeypress="return isNumberKey(event)" onkeyup="this.value=formatCurrency(this.value);countTotal();"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr bgcolor="#ebecec">
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtTotalExposureKredit" runat="server" CssClass="inpTxtDisabled" style="float:none;" value="0" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr bgcolor="#ebecec">
                        ...
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtKelonggaranBMPK" runat="server" CssClass="inpTxtDisabled" style="float:none;" value="0" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#f6f7f7">
                        <td><b>Kelonggaran Inhouse Limit BMPK Inhouse Limit</b></td>
                        <td>
                            Rp.&nbsp;
                            <asp:TextBox ID="txtKelonggaranInhouse" runat="server" CssClass="inpTxtDisabled" style="float:none;" value="0" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr bgcolor="#ebecec">
                        <td><b>Presentasi Kredit Terhadap BMPK</b></td>
                        <td>
                            <asp:TextBox ID="txtProsentaseKreditToBMPK" runat="server" CssClass="inpTxtDisabled" style="float:none;margin-left:23px;" value="0" ReadOnly="true"></asp:TextBox>
                            &nbsp;%
                        </td>
                    </tr>
