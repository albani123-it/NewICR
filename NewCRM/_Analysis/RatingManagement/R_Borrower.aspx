<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="R_Borrower.aspx.vb" 
Inherits="NewCRM.R_Borrower" %>
    ...
    <script type="text/javascript">
        ...
        function fDetail(url){
            ...
            if (appno == "")
                ...
                window.location.href = url +"?appno=" + appno +"&typ=Borrower" +"&typ2=Facility";
        }
            ...
            <div class="bodyContent">
                ...
                <table class="tbl" cellspacing="0" cellpadding="2" width="100%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;">
                    ...
                    <tr bgcolor="#ebecec">
                        ...
                        <td><b>Hubungan dengan Bank DKI Sejak</b></td>
                        <td>
                    ...
                    <tr bgcolor="#f6f7f7">
                        ...
                        <td><b>Menjadi Debitur DKI Sejak</b></td>
                        <td>
