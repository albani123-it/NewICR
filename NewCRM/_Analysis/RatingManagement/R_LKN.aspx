<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="R_LKN.aspx.vb" Inherits="NewCRM.R_LKN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <td style="padding:0;">
                            ...
                            AllowPageSizeSelection="false" AllowFiltering="true" AllowRecordSelection="false" FolderStyle="~/styles/grid">
                                ...
                                <Columns>
                                    ...
                                    <obout:Column id="Column4" runat="server" DataField="lsl_nama" HeaderText="Nama Nasabah" ShowFilterCriterias="false" Width="15%" Wrap="true">
                                        <TemplateSettings RowEditTemplateControlId="TxtNama" RowEditTemplateControlPropertyName="value" FilterTemplateId="NamaFilter" />
                                        <FilterOptions>
                                            <obout:FilterOption IsDefault="true" Type="Contains" />
                                        </FilterOptions>
                                    </obout:Column>
                                    <obout:Column id="Column5" runat="server" DataField="lsl_bentuk" HeaderText="Bentuk Kontak" ShowFilterCriterias="false" Width="15%" Wrap="true">
                                    ...
                                    <obout:Column id="Column6" runat="server" DataField="lsl_tujuan" HeaderText="Tujuan Kontak" ShowFilterCriterias="false" Width="15%" Wrap="true">
                                    ...
                                    <obout:Column id="Column9" runat="server" DataField="lsl_hasil" HeaderText="Hasil Kontak" ShowFilterCriterias="false" Width="25%" Wrap="true">
    ...
    <script type="text/javascript">
        ...
        function fEdit(id) {
            ...
            l_obj_argument.url = "R_LKNDet.aspx?id=" + id + "&appno=" + brw + "&status=" + stat;
