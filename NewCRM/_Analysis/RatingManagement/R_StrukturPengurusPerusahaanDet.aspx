<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="R_StrukturPengurusPerusahaanDet.aspx.vb" Inherits="NewCRM.R_StrukturPengurusPerusahaanDet" %>
        ...
        <center>
            ...
            <table id="tblStrukturPengurus" class="tbl" cellspacing="0" cellpadding="3">
                ...
                <tr>
                    ...
                    <td width="30%">
                        <asp:TextBox ID="txtTgllahir" data-name="date" runat="server" CssClass="inpTxt"></asp:TextBox>
                        <span style="color: Red; font-size: 11pt; font-weight: bold;">&nbsp;*</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtMasaKerjaDari" data-name="date" runat="server" CssClass="inpTxt"></asp:TextBox>
                        &nbsp; &nbsp;&nbsp;<b>Sampai</b>
                    </td>
                    <td colspan="3">
                        <asp:TextBox ID="txtSampaiTgl" data-name="date" runat="server" CssClass="inpTxt"></asp:TextBox>
                    </td>
                </tr>
                 <tr>
                    <td>
