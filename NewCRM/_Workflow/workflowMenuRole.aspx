<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="workflowMenuRole.aspx.vb" Inherits="NewCRM.workflowMenuRole" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function fEdit(id) {
            ...
            var wfpid = document.getElementById("<%= ddlProcess.clientID %>").value;
            var sector = document.getElementById("<%= ddlSector.clientID %>").value;
            var l_obj_argument = new Object();
            l_obj_argument.url = "workflowMenuRoleDet.aspx?id=" + id + "&wfid=" + wfid + "&wfpid=" + wfpid + "&sec=" + sector;
    ...
    <div style="clear:both; margin:0 auto; padding:0; width:98%;margin-bottom:20px;">
        ...
        <div style="margin-bottom:20px;border: thin solid #bcbcbc;border-radius: 5px;margin-top: 5px;"">
            <ul class="top-bar">
              ...
              <li class="list-bar"><a href="javascript:fDetail('workflowMenuRole.aspx');" class="active">Workflow Role</a></li>
              <li class="list-bar" style="float:right"><a href="javascript:fDetail('workflowProcessDet.aspx');""><< Prev</a></li>
            </ul>
        </div>
        <div style="margin-bottom:20px;">
            <table cellspacing="0" cellpadding="2" width="60%" style="text-align:left;border: thin solid #bcbcbc;border-radius: 5px;margin-top: 5px;">
                ...
                <tr bgcolor="#f6f7f7">
                    <td><b>Sector</b></td>
                    <td>
                        <asp:DropDownList ID="ddlSector" runat="server" CssClass="inpDdl"></asp:DropDownList>
                        <span style="color:Red;font-size:11pt;font-weight:bold;">*</span>
                    </td>
                </tr>
                <tr style="height:30px">
                    <td colspan="2" background="../styles/grid/footer.gif" style="border-radius: 0 0 5px 5px;">
                        <asp:button id="btnView" runat="server" Text="View" CssClass="inpBtn"></asp:button>
                    </td>
                </tr>
            </table>
        </div>
        <obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" PageSize="-1"
            ...
            <Columns>
                <obout:Column id="Column1" runat="server" DataField="lwr_id" Visible="false"></obout:Column>
                <obout:Column id="Column2" runat="server" DataField="lsm_name" HeaderText="Name" Width="40%" Wrap="true"></obout:Column>
                <obout:Column id="Column3" runat="server" DataField="Roles" HeaderText="Role" Width="20%" Wrap="true"></obout:Column>
