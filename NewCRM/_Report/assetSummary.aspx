<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="assetSummary.aspx.vb" Inherits="NewCRM.assetSummary" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <ServerReport 
                ReportPath="/basel_dki/asset_summary" />
        </rsweb:ReportViewer>
</div>
