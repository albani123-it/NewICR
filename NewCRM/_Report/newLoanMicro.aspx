<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="newLoanMicro.aspx.vb" Inherits="NewCRM.newLoanMicro" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <ServerReport 
                ReportPath="/basel_dki/newLoanMicro" />
        </rsweb:ReportViewer>
</div>
