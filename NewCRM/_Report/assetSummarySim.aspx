<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="assetSummarySim.aspx.vb" Inherits="NewCRM.assetSummarySim" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <ServerReport 
                ReportPath="/basel_dki/asset_summary_sim" />
        </rsweb:ReportViewer>
</div>
