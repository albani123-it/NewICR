<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ratingFacility.aspx.vb" Inherits="NewCRM.ratingFacility" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <ServerReport 
                ReportPath="/basel_dki/reratingFcy" />
        </rsweb:ReportViewer>
</div>
