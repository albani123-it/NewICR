<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="riskPremium.aspx.vb" Inherits="NewCRM.riskPremium" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="clear: both; margin: 0 auto; padding: 0; width: 98%">
        ...
        <div id="myChart" style="width: 100%; height: 400px;">
            <div id="titleMenu">
                <h2>Laporan Risk Premium</h2>
            </div>
            <img src="../Images/line-risk-premium.png" />
        </div>
    </div>
</asp:Content>
