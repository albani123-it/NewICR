<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="creditRisk.aspx.vb" Inherits="NewCRM.creditRisk" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="clear: both; margin: 0 auto; padding: 0; width: 98%">
        ...
        <div id="myChart" style="width: 100%; height: 400px;">
            <div id="titleMenu">
                <h2>Laporan Estimasi Komponen Risiko Kredit</h2>
            </div>
            <img src="../Images/line-credit-risk.png" />
        </div>
    </div>
</asp:Content>
