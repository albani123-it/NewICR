<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="lossPotential.aspx.vb" Inherits="NewCRM.lossPotential" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="clear: both; margin: 0 auto; padding: 0; width: 98%">
        ...
        <div id="myChart" style="width: 100%; height: 400px;">
            <div id="titleMenu">
                <h2>Transition Matriks</h2>
            </div>
            <img src="../Images/line-loss-potensial.png" />
        </div>
    </div>
</asp:Content>
