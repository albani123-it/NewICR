<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ratingMix.aspx.vb" Inherits="NewCRM.ratingMix" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <ServerReport 
                ReportPath="/basel_dki/reratingMicro" />
        </rsweb:ReportViewer>
</div>
